package net.gyllowe.dualcoloredshulkers._wip.Rendering_SecondAttempt;

import net.minecraft.client.render.SpriteTexturedVertexConsumer;
import net.minecraft.client.render.VertexConsumer;
import net.minecraft.client.texture.Sprite;

public class RSA_DualShulkerVertexConsumer
    ...
    public RSA_DualShulkerVertexConsumer(VertexConsumer parent, Sprite sprite, Boolean hasSecondaryColor, Sprite secondSprite) {
        super(parent, sprite);
        this.parent = parent;
        this.sprite = sprite;
